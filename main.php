...
<table class="container" border="1">
    <tr>
        <td> <img src="/media/portatil1.jpg"/> </td>
        <td> <img src="/media/portatil2.jpg"/> </td>
        <td> <img src="/media/portatil3.jpg"/> </td>
    </tr>
    <tr>
        <td> <p> portatil 1 </p> </td>
        <td> <p> portatil 2 </p> </td>
        <td> <p> portatil 3 </p> </td>
    </tr>
</table>
-->
