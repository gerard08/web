...
<div id="taulell">
    ...
    <form id="register" onsubmit="return registraUsuari();" method="post">
        ...
        <input type="password" placeholder="Repeteix la contrasenya" id="contra2" required="required">
        <input type="text" placeholder="Direcció" id="dir" required="required">
        <input type="text" placeholder="Població" id="pob" required="required">
        <input type="number" placeholder="Codi Postal" id="cp" required="required">
    ...
    <div id="separador">
        ...
        <form id = "login" onsubmit="return iniciaSessio();" method="post">
